...
public class Main {
	...
	public static void main(String[] args) {
		...
		solutionMap.put("bp", new PropertyBoundaries(0.5, 0.5));
		solutionMap.put("map", new PropertyBoundaries(0.5, 0.5));
		solutionMap.put("gp", new PropertyBoundaries(0.5, 0.5));
		solutionMap.put("sap", new PropertyBoundaries(0.5, 0.5));
		solutionMap.put("wp", new PropertyBoundaries(0.5, 0.5));
		...
		execHarmonySearch(hpa, 100, PRINT_NEW_SOLUTIONS, PRINT_MEMORY_SWAPS);
...
//		fiveStreams("./lib/realStates_1560.csv");
	 ...
	 * @return void, final solutions are swapped inplace in hpa
	 */
	public static void execHarmonySearch(HarmonyParameters hpa, int nrOfIter, boolean printNewSolutions,
			boolean printMemorySwaps) {
		Random rand = new Random();
		if (printNewSolutions || printMemorySwaps)
			Printer.printHeader("ALGORITHM START: FIRST ITERATION");
		for (int i = 0; i < nrOfIter; i++) {
			...
			evalSolution(newSolution, hpa.getSolutions(), "./lib/realStates_156.csv", printNewSolutions,
					printMemorySwaps);
		}
	 ...
	 */
	public static void printGrid(List<Map<String, PropertyBoundaries>> solutions) {
	 ...
	 * @param printMemorySwaps   .. print statements of memory swaps
	 */
	public static void evalSolution(Map<String, PropertyBoundaries> newSolution,
			List<Map<String, PropertyBoundaries>> solutions, String realStatesFilePath, boolean printNewSolutions,
			boolean printMemorySwaps) {
		...
		if (printNewSolutions) {
			Printer.printHeader("New solution");
